...
class Branches extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['companies_company_id', 'branch_name', 'branch_address', 'branch_created_at', 'branch_status'], 'required'],
    ...
    {
        return $this->hasMany(Departments::className(), ['branches_branches_id' => 'branch_id']);
    }
}
